...
<body>
    ...
    <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin5" data-sidebartype="full" data-sidebar-position="absolute" data-header-position="absolute" data-boxed-layout="full">
        ...
        <div class="page-wrapper">
            ...
            <!-- ============================================================== -->
        <?php if($template == "validationPorteFeuille.php") { include($template); } else if($template == "ajoutPlace.php") { include($template); } else if($template == "parametre.php") { include($template); } else if($template == "tarif.php") { include($template); } else if($template == "crudTarif.php") { include($template); } else { ?>
